package com.softtech.fcmtask.base.notifications
...
class NotificationsUtil(
    ...
    fun createOngoingNotification(service: Service, title: String, text: String, pendingIntent: PendingIntent?=null) {
    ...
    fun createAlertNotification(id: Int, title: String, text: String, pendingIntent: PendingIntent? = null) {
